...
LOCALIZED_MODULE_03_ITERATION = LocalizedLearningModule(
    ...
    concepts=(
        LocalizedConceptBlock(
            ...
            key_points=(
                _t(
                    "El estado cambia entre iteraciones.",
                    "State changes between iterations.",
                    "Tilstanden ændres mellem iterationer.",
                ),
                _t(
                    "La condición decide si se ejecuta otra iteración.",
                    "The condition decides whether another iteration executes.",
                    "Betingelsen afgør, om endnu en iteration udføres.",
                ),
                _t(
                    "La actualización debe contribuir al progreso.",
                    "The update must contribute to progress.",
                    "Opdateringen skal bidrage til fremdrift.",
                ),
                _t(
                    "El resultado final depende tanto del cuerpo como de la terminación.",
                    "The final result depends on both the body and termination.",
                    "Det endelige resultat afhænger både af kroppen og afslutningen.",
                ),
            ),
        ),
        LocalizedConceptBlock(
            ...
            key_points=(
                _t(
                    "while comprueba la condición antes del cuerpo.",
                    "while checks the condition before the body.",
                    "while kontrollerer betingelsen før kroppen.",
                ),
                _t(
                    "La inicialización debe establecer un estado válido.",
                    "Initialization must establish a valid state.",
                    "Initialiseringen skal etablere en gyldig tilstand.",
                ),
                _t(
                    "La actualización suele modificar una variable presente en la condición.",
                    "The update usually changes a variable used by the condition.",
                    "Opdateringen ændrer normalt en variabel, der indgår i betingelsen.",
                ),
                _t(
                    "Cero iteraciones puede ser el comportamiento correcto.",
                    "Zero iterations may be correct behaviour.",
                    "Nul iterationer kan være korrekt adfærd.",
                ),
            ),
        ),
        LocalizedConceptBlock(
            ...
            key_points=(
                _t(
                    "Una medida de progreso debe acercarse a un límite.",
                    "A progress measure must move towards a bound.",
                    "Et fremdriftsmål skal bevæge sig mod en grænse.",
                ),
                _t(
                    "Un invariante describe lo que sigue siendo cierto.",
                    "An invariant describes what remains true.",
                    "En invariant beskriver det, der forbliver sandt.",
                ),
                _t(
                    "Olvidar la actualización puede producir un bucle infinito.",
                    "Omitting the update can produce an infinite loop.",
                    "En manglende opdatering kan skabe en uendelig løkke.",
                ),
                _t(
                    "Terminar no basta: el estado final también debe ser correcto.",
                    "Termination is not enough: the final state must also be correct.",
                    "Afslutning er ikke nok: sluttilstanden skal også være korrekt.",
                ),
            ),
        ),
        LocalizedConceptBlock(
            ...
            key_points=(
                _t(
                    "El valor stop de range no se incluye.",
                    "The stop value of range is excluded.",
                    "Stopværdien i range medtages ikke.",
                ),
                _t(
                    "range(n) genera n valores: 0 hasta n - 1.",
                    "range(n) generates n values: 0 through n - 1.",
                    "range(n) genererer n værdier: 0 til n - 1.",
                ),
                _t("step no puede ser cero.", "step cannot be zero.", "step kan ikke være nul."),
                _t(
                    "for comunica que el recorrido está acotado por un iterable.",
                    "for communicates that traversal is bounded by an iterable.",
                    "for kommunikerer, at gennemløbet er afgrænset af et iterabelt objekt.",
                ),
            ),
        ),
        LocalizedConceptBlock(
            ...
            key_points=(
                _t(
                    "Un contador responde cuántos.",
                    "A counter answers how many.",
                    "En tæller svarer på hvor mange.",
                ),
                _t(
                    "Un acumulador conserva un resultado parcial.",
                    "An accumulator stores a partial result.",
                    "En akkumulator gemmer et delresultat.",
                ),
                _t(
                    "La identidad inicial depende de la operación.",
                    "The initial identity depends on the operation.",
                    "Startidentiteten afhænger af operationen.",
                ),
                _t(
                    "Máximos y mínimos requieren una inicialización válida.",
                    "Maximum and minimum tracking requires valid initialization.",
                    "Sporing af maksimum og minimum kræver gyldig initialisering.",
                ),
            ),
        ),
        LocalizedConceptBlock(
            ...
            key_points=(
                _t(
                    "El centinela controla el final y no se acumula como dato.",
                    "The sentinel controls termination and is not accumulated as data.",
                    "Stopværdien styrer afslutningen og akkumuleres ikke som data.",
                ),
                _t(
                    "break finaliza el bucle más interno.",
                    "break terminates the innermost loop.",
                    "break afslutter den inderste løkke.",
                ),
                _t(
                    "continue no finaliza el bucle; salta a la siguiente iteración.",
                    "continue does not terminate the loop; it skips to the next iteration.",
                    "continue afslutter ikke løkken; den går videre til næste iteration.",
                ),
                _t(
                    "La estructura más simple que expresa correctamente el algoritmo suele ser preferible.",
                    "The simplest structure that correctly expresses the algorithm is usually preferable.",
                    "Den enkleste struktur, der korrekt udtrykker algoritmen, er normalt at foretrække.",
                ),
            ),
        ),
        LocalizedConceptBlock(
            ...
            key_points=(
                _t(
                    "Los recuentos de bucles anidados suelen multiplicarse.",
                    "Nested-loop counts usually multiply.",
                    "Antallet af iterationer i indlejrede løkker multipliceres normalt.",
                ),
                _t(
                    "Cada variable de control debe tener un significado independiente.",
                    "Each control variable needs an independent meaning.",
                    "Hver kontrolvariabel skal have en selvstændig betydning.",
                ),
                _t(
                    "break solo abandona el bucle más interno.",
                    "break exits only the innermost loop.",
                    "break forlader kun den inderste løkke.",
                ),
                _t(
                    "El coste debe relacionarse con los límites del problema.",
                    "Cost should be related to the problem bounds.",
                    "Omkostningen bør knyttes til problemets grænser.",
                ),
            ),
        ),
        LocalizedConceptBlock(
            ...
            key_points=(
                _t(
                    "El trazado sigue el orden real de evaluación.",
                    "Tracing follows the actual evaluation order.",
                    "Gennemgang følger den faktiske evalueringsrækkefølge.",
                ),
                _t(
                    "Cero, una y varias iteraciones son casos distintos.",
                    "Zero, one, and many iterations are distinct cases.",
                    "Nul, én og mange iterationer er forskellige tilfælde.",
                ),
                _t(
                    "Los límites revelan errores de uno en uno.",
                    "Boundary cases expose off-by-one errors.",
                    "Grænsetilfælde afslører én-for-meget- eller én-for-lidt-fejl.",
                ),
                _t(
                    "Una prueba de tiempo no demuestra corrección.",
                    "A time limit does not prove correctness.",
                    "En tidsgrænse beviser ikke korrekthed.",
                ),
            ),
        ),
    ),
    worked_examples=(
        LocalizedWorkedExample(
            ...
            reasoning=(
                _t(
                    "El estado está formado por signal y attempts.",
                    "The state consists of signal and attempts.",
                    "Tilstanden består af signal og attempts.",
                ),
                _t(
                    "El bucle continúa solo mientras falten ambos criterios de parada.",
                    "The loop continues only while both stopping criteria remain unmet.",
                    "Løkken fortsætter kun, mens begge stopkriterier endnu ikke er opfyldt.",
                ),
                _t(
                    "Cada iteración aumenta attempts y modifica signal.",
                    "Each iteration increments attempts and modifies signal.",
                    "Hver iteration øger attempts og ændrer signal.",
                ),
                _t(
                    "attempts está acotado por 4, por lo que la terminación es demostrable.",
                    "attempts is bounded by 4, so termination is demonstrable.",
                    "attempts er afgrænset af 4, så afslutningen kan påvises.",
                ),
            ),
            code=_same(
        ...
        LocalizedWorkedExample(
            ...
            reasoning=(
                _t(
                    "El número de repeticiones se conoce de antemano, por lo que for es apropiado.",
                    "The repetition count is known in advance, so for is appropriate.",
                    "Antallet af gentagelser kendes på forhånd, så for er passende.",
                ),
                _t(
                    "range(1, 7) produce los identificadores 1 a 6.",
                    "range(1, 7) produces identifiers 1 through 6.",
                    "range(1, 7) producerer identifikatorerne 1 til 6.",
                ),
                _t(
                    "total_ul comienza en 0 porque acumula una suma.",
                    "total_ul starts at 0 because it accumulates a sum.",
                    "total_ul begynder ved 0, fordi variablen akkumulerer en sum.",
                ),
                _t(
                    "Después de cada iteración, total_ul representa el volumen de las réplicas ya procesadas.",
                    "After each iteration, total_ul represents the volume of the replicates processed so far.",
                    "Efter hver iteration repræsenterer total_ul volumenet for de hidtil behandlede replikater.",
                ),
            ),
            code=_same(
        ...
        LocalizedWorkedExample(
            ...
            reasoning=(
                _t(
                    "range(1, 9) genera ocho números de ciclo.",
                    "range(1, 9) generates eight cycle numbers.",
                    "range(1, 9) genererer otte cyklusnumre.",
                ),
                _t(
                    "passing_count es un contador y passing_sum un acumulador.",
                    "passing_count is a counter and passing_sum an accumulator.",
                    "passing_count er en tæller, og passing_sum er en akkumulator.",
                ),
                _t(
                    "Ambos se actualizan únicamente cuando la condición es verdadera.",
                    "Both update only when the condition is true.",
                    "Begge opdateres kun, når betingelsen er sand.",
                ),
                _t(
                    "round se utiliza solo para presentar la suma con claridad.",
                    "round is used only to present the sum clearly.",
                    "round bruges kun til at præsentere summen tydeligt.",
                ),
            ),
            code=_same(
        ...
        LocalizedWorkedExample(
            ...
            reasoning=(
                _t(
                    "El objetivo es la primera coincidencia, no todas las coincidencias.",
                    "The goal is the first match, not all matches.",
                    "Målet er den første match, ikke alle matches.",
                ),
                _t(
                    "for limita la búsqueda a diez ciclos.",
                    "for bounds the search to ten cycles.",
                    "for afgrænser søgningen til ti cyklusser.",
                ),
                _t(
                    "Cuando la condición es verdadera se registra el ciclo y break evita trabajo posterior.",
                    "When the condition is true, the cycle is recorded and break avoids later work.",
                    "Når betingelsen er sand, registreres cyklussen, og break undgår senere arbejde.",
                ),
                _t(
                    "found_cycle se inicializa con None para representar que aún no existe coincidencia.",
                    "found_cycle starts as None to represent that no match exists yet.",
                    "found_cycle initialiseres med None for at repræsentere, at der endnu ikke findes et match.",
                ),
            ),
            code=_same(
        ...
        LocalizedWorkedExample(
            ...
            reasoning=(
                _t(
                    "El bucle exterior representa las filas.",
                    "The outer loop represents rows.",
                    "Den ydre løkke repræsenterer rækker.",
                ),
                _t(
                    "Para cada fila, el bucle interior recorre cuatro columnas.",
                    "For each row, the inner loop traverses four columns.",
                    "For hver række gennemløber den indre løkke fire kolonner.",
                ),
                _t(
                    "visited aumenta una vez por combinación fila-columna.",
                    "visited increases once per row-column combination.",
                    "visited øges én gang pr. række-kolonne-kombination.",
                ),
                _t(
                    "El cuerpo interior se ejecuta 3 × 4 = 12 veces.",
                    "The inner body executes 3 × 4 = 12 times.",
                    "Den indre krop udføres 3 × 4 = 12 gange.",
                ),
            ),
            code=_same(
    ...
    practice_exercises=(
        LocalizedPracticeExercise(
            ...
            hints=(
                _t(
                    "Comprueba la condición antes de imprimir.",
                    "Check the condition before printing.",
                    "Kontrollér betingelsen før udskrivning.",
                ),
                _t(
                    "Registra x después de sumar 3.",
                    "Record x after adding 3.",
                    "Registrér x efter at have lagt 3 til.",
                ),
            ),
        ...
        LocalizedPracticeExercise(
            ...
            hints=(
                _t(
                    "La condición depende de count.",
                    "The condition depends on count.",
                    "Betingelsen afhænger af count.",
                ),
                _t(
                    "Alguna instrucción del cuerpo debe acercar count a 5.",
                    "A body statement must move count towards 5.",
                    "En instruktion i kroppen skal føre count mod 5.",
                ),
            ),
        ...
        LocalizedPracticeExercise(
            ...
            hints=(
                ...
                _t(
                    "stop debe quedar después de 11 porque no se incluye.",
                    "stop must lie beyond 11 because it is excluded.",
                    "stop skal ligge efter 11, fordi værdien ikke medtages.",
                ),
            ),
        ...
        LocalizedPracticeExercise(
            ...
            hints=(
                _t(
                    "El resto de dividir por 4 debe ser 0.",
                    "The remainder after division by 4 must be 0.",
                    "Resten efter division med 4 skal være 0.",
                ),
        ...
        LocalizedPracticeExercise(
            ...
            hints=(
                _t(
                    "Enumera los valores desde 0.",
                    "List the values starting from 0.",
                    "Angiv værdierne fra 0.",
                ),
            ),
            solution=_t(
        ...
        LocalizedPracticeExercise(
            ...
            hints=(
                _t(
                    "range(1, 5) genera 1, 2, 3 y 4.",
                    "range(1, 5) generates 1, 2, 3, and 4.",
                    "range(1, 5) genererer 1, 2, 3 og 4.",
                ),
            ),
        ...
        LocalizedPracticeExercise(
            ...
            hints=(
                _t(
                    "La primera comprobación ocurre antes del cuerpo.",
                    "The first check occurs before the body.",
                    "Den første kontrol sker før kroppen.",
                ),
            ),
            solution=_t(
        ...
        LocalizedPracticeExercise(
            ...
            hints=(
                _t(
                    "Lee el primer valor antes del while.",
                    "Read the first value before the while loop.",
                    "Læs den første værdi før while-løkken.",
                ),
                _t(
                    "Lee el siguiente valor al final del cuerpo.",
                    "Read the next value at the end of the body.",
                    "Læs den næste værdi sidst i kroppen.",
                ),
            ),
            starter_code=_same(
                "total = 0\nvalue = int(input())\nwhile __________:\n    total += value\n    value = int(input())"
        ...
        LocalizedPracticeExercise(
            ...
            hints=(
                _t(
                    "Relaciona la medida con la distancia hasta el límite.",
                    "Relate the measure to distance from the bound.",
                    "Knyt målet til afstanden fra grænsen.",
                ),
            ),
            solution=_t(
        ...
        LocalizedPracticeExercise(
            ...
            hints=(
                _t(
                    "Multiplica las iteraciones exterior e interior.",
                    "Multiply outer and inner iteration counts.",
                    "Multiplicér antallet af ydre og indre iterationer.",
                ),
            ),
            solution=_same("6"),
            explanation=_t(
        ...
        LocalizedPracticeExercise(
            ...
            hints=(
                _t(
                    "Distingue repetición controlada por condición y repetición acotada por un iterable.",
                    "Distinguish condition-controlled repetition from iterable-bounded repetition.",
                    "Skeln mellem betingelsesstyret gentagelse og gentagelse afgrænset af et iterabelt objekt.",
                ),
            ),
            solution=_t(
    ...
    assessment_items=(
        LocalizedAssessmentItem(
            ...
            prompt=_t(
                "¿Qué estructura es más directa para repetir exactamente 12 veces?",
                "Which structure is most direct for repeating exactly 12 times?",
                "Hvilken struktur er mest direkte til at gentage præcis 12 gange?",
            ),
            options=(
                ...
                _option(
                    ...
                    "while True uden break",
                ),
                _option(
                    "if", "if ejecutado 12 veces", "if executed 12 times", "if udført 12 gange"
                ),
                _option(
                    "recursion",
                    "Recursión sin caso base",
                    "Recursion without a base case",
                    "Rekursion uden basistilfælde",
                ),
            ),
            correct_option_ids=("for",),
            accepted_answers=(),
            explanation=_t(
                "for con range expresa de forma directa una repetición acotada conocida.",
                "for with range directly expresses known bounded repetition.",
                "for med range udtrykker direkte en kendt afgrænset gentagelse.",
            ),
        ),
        LocalizedAssessmentItem(
            item_id="m03.a02",
            ...
            prompt=_t(
                "Un while puede ejecutar su cuerpo cero veces.",
                "A while loop may execute its body zero times.",
                "En while-løkke kan udføre sin krop nul gange.",
            ),
            options=(
            ...
            explanation=_t(
                ...
                "Betingelsen evalueres før kroppen.",
            ),
        ),
        LocalizedAssessmentItem(
            item_id="m03.a03",
            ...
            explanation=_t(
                "8 es el límite exclusivo.",
                "8 is the exclusive bound.",
                "8 er den eksklusive grænse.",
            ),
            rubric=(
                _t(
                    "Incluye 2, 4 y 6 en ese orden.",
                    "Includes 2, 4, and 6 in that order.",
                    "Medtager 2, 4 og 6 i den rækkefølge.",
                ),
            ),
        ),
        LocalizedAssessmentItem(
            ...
            activity_type=ActivityType.FILL_IN_THE_BLANK,
            prompt=_t(
                "Completa la actualización para garantizar progreso: while count < 10: count ____ 1.",
                "Complete the update to guarantee progress: while count < 10: count ____ 1.",
                "Fuldfør opdateringen for at sikre fremdrift: while count < 10: count ____ 1.",
            ),
            options=(),
            correct_option_ids=(),
            accepted_answers=(_same("+=\n"), _same("+=")),
            explanation=_t(
                "count += 1 aumenta la variable utilizada por la condición.",
                "count += 1 increases the variable used by the condition.",
                "count += 1 øger variablen, der bruges i betingelsen.",
            ),
        ),
        LocalizedAssessmentItem(
            item_id="m03.a05",
            activity_type=ActivityType.DEBUGGING,
            prompt=_t(
                "Corrige el bucle para imprimir 5, 4, 3, 2, 1 y terminar.",
                "Correct the loop to print 5, 4, 3, 2, 1 and terminate.",
                "Ret løkken, så den udskriver 5, 4, 3, 2, 1 og afslutter.",
            ),
            options=(),
            correct_option_ids=(),
            accepted_answers=(
            ...
            explanation=_t(
                "La actualización debe reducir value hacia el límite 0.",
                "The update must reduce value towards the bound 0.",
                "Opdateringen skal reducere value mod grænsen 0.",
            ),
            rubric=(
                _t(
                    "Usa una condición que excluye 0.",
                    "Uses a condition that excludes 0.",
                    "Bruger en betingelse, der udelukker 0.",
                ),
                _t(
                    "Reduce value en cada iteración.",
                    "Decreases value each iteration.",
                    "Reducerer value i hver iteration.",
                ),
                _t(
                    "Conserva el orden 5 a 1.",
                    "Preserves the order 5 to 1.",
                    "Bevarer rækkefølgen 5 til 1.",
                ),
            ),
        ),
        LocalizedAssessmentItem(
            ...
            prompt=_t(
                "Selecciona todas las propiedades necesarias para argumentar la terminación de un while.",
                "Select every property needed to argue that a while loop terminates.",
                "Vælg alle egenskaber, der er nødvendige for at argumentere for, at en while-løkke afslutter.",
            ),
            options=(
                _option(
                    "progress",
                    "Existe una medida de progreso",
                    "A progress measure exists",
                    "Der findes et fremdriftsmål",
                ),
                _option(
                    "bound",
                    "La medida está acotada",
                    "The measure is bounded",
                    "Målet er afgrænset",
                ),
                _option(
                    "change",
                    "Cada iteración acerca la medida al límite",
                    "Each iteration moves the measure towards the bound",
                    "Hver iteration fører målet mod grænsen",
                ),
                _option(
                    "print",
                    "El cuerpo contiene print",
                    "The body contains print",
                    "Kroppen indeholder print",
                ),
            ),
            correct_option_ids=("progress", "bound", "change"),
            accepted_answers=(),
            explanation=_t(
                "La salida visible no garantiza progreso ni terminación.",
                "Visible output does not guarantee progress or termination.",
                "Synligt output garanterer ikke fremdrift eller afslutning.",
            ),
        ),
        LocalizedAssessmentItem(
            item_id="m03.a07",
            ...
            prompt=_t(
                "Relaciona cada patrón con su propósito.",
                "Match each pattern with its purpose.",
                "Match hvert mønster med dets formål.",
            ),
            options=(
                _option(
                    "counter",
                    "contador → número de ocurrencias",
                    "counter → number of occurrences",
                    "tæller → antal forekomster",
                ),
                _option(
                    "accumulator",
                    "acumulador → resultado parcial combinado",
                    "accumulator → combined partial result",
                    "akkumulator → kombineret delresultat",
                ),
                _option(
                    "flag",
                    "indicador → estado booleano recordado",
                    "flag → remembered Boolean state",
                    "flag → husket boolesk tilstand",
                ),
                _option(
                    "best",
                    "mejor valor → máximo o mínimo observado",
                    "best value → observed maximum or minimum",
                    "bedste værdi → observeret maksimum eller minimum",
                ),
            ),
            correct_option_ids=("counter", "accumulator", "flag", "best"),
            accepted_answers=(),
            explanation=_t(
                "Cada patrón mantiene una forma distinta de estado durante el recorrido.",
                "Each pattern maintains a different form of state during traversal.",
                "Hvert mønster vedligeholder en forskellig form for tilstand under gennemløbet.",
            ),
        ),
        LocalizedAssessmentItem(
            item_id="m03.a08",
            activity_type=ActivityType.ORDERING,
            prompt=_t(
                "Ordena las acciones de un acumulador de suma.",
                "Order the actions of a summation accumulator.",
                "Sæt handlingerne for en sumakkumulator i rækkefølge.",
            ),
            options=(
                _option(
                    "initialize",
                    ...
                    "Initialisér total til 0",
                ),
                _option(
                    "obtain",
                    "Obtener el siguiente valor",
                    "Obtain the next value",
                    "Hent den næste værdi",
                ),
                _option(
                    "combine",
                    "Sumar el valor a total",
                    "Add the value to total",
                    "Læg værdien til total",
                ),
                _option(
                    "repeat",
                    "Repetir mientras queden valores",
                    "Repeat while values remain",
                    "Gentag mens der er værdier tilbage",
                ),
                _option(
                    "report",
                    "Mostrar total final",
                    "Report the final total",
                    "Vis den endelige total",
                ),
            ),
            correct_option_ids=("initialize", "obtain", "combine", "repeat", "report"),
            accepted_answers=(),
            explanation=_t(
                "La identidad 0 se establece antes de combinar valores y el resultado se informa al final.",
                "The identity 0 is established before combining values and the result is reported at the end.",
                "Identiteten 0 etableres før værdier kombineres, og resultatet vises til sidst.",
            ),
        ),
        LocalizedAssessmentItem(
            item_id="m03.a09",
            activity_type=ActivityType.SHORT_ANSWER,
            prompt=_t(
                "Define un invariante adecuado para sumar los enteros 1 a n con un bucle.",
                "Define a suitable invariant for summing the integers 1 through n with a loop.",
                "Definér en passende invariant til at summere heltallene 1 til n med en løkke.",
            ),
            options=(),
            correct_option_ids=(),
            accepted_answers=(
                _t(
                    "Después de procesar k, total contiene la suma de 1 hasta k.",
                    "After processing k, total contains the sum from 1 through k.",
                    "Efter behandling af k indeholder total summen fra 1 til k.",
                ),
            ),
            explanation=_t(
                "El invariante relaciona el estado parcial con los elementos ya procesados.",
                "The invariant relates partial state to the elements already processed.",
                "Invarianten knytter deltilstanden til de elementer, der allerede er behandlet.",
            ),
            rubric=(
                _t(
                    "Identifica qué elementos se han procesado.",
                    "Identifies which elements have been processed.",
                    "Identificerer hvilke elementer der er behandlet.",
                ),
                _t(
                    "Relaciona total con la suma parcial correcta.",
                    "Relates total to the correct partial sum.",
                    "Knytter total til den korrekte delsum.",
                ),
            ),
        ),
        LocalizedAssessmentItem(
            ...
            activity_type=ActivityType.CODE_COMPLETION,
            prompt=_t(
                "Completa un for que imprima 10, 8, 6, 4 y 2.",
                "Complete a for loop that prints 10, 8, 6, 4, and 2.",
                "Fuldfør en for-løkke, der udskriver 10, 8, 6, 4 og 2.",
            ),
            options=(),
            correct_option_ids=(),
            accepted_answers=(_same("for value in range(10, 1, -2):\n    print(value)"),),
            explanation=_t(
                "El step negativo reduce value y stop=1 permite incluir 2.",
                "The negative step reduces value and stop=1 allows 2 to be included.",
                "Det negative trin reducerer value, og stop=1 gør det muligt at medtage 2.",
            ),
        ),
        LocalizedAssessmentItem(
            item_id="m03.a11",
            ...
            prompt=_t(
                "Una tabla de trazado muestra count: 0, 1, 2, 3, 4 y después la condición count < 4 es False. ¿Cuántas veces se ejecutó el cuerpo?",
                "A trace table shows count: 0, 1, 2, 3, 4 and then count < 4 is False. How many times did the body execute?",
                "En gennemgangstabel viser count: 0, 1, 2, 3, 4, og derefter er count < 4 False. Hvor mange gange blev kroppen udført?",
            ),
            options=(),
            correct_option_ids=(),
            accepted_answers=(_same("4"),),
            explanation=_t(
                "El cuerpo se ejecutó con count igual a 0, 1, 2 y 3.",
                "The body executed with count equal to 0, 1, 2, and 3.",
                "Kroppen blev udført med count lig 0, 1, 2 og 3.",
            ),
        ),
        LocalizedAssessmentItem(
            item_id="m03.a12",
            activity_type=ActivityType.TRUE_FALSE,
            prompt=_t(
                "continue termina inmediatamente el bucle actual.",
                "continue immediately terminates the current loop.",
                "continue afslutter straks den aktuelle løkke.",
            ),
            options=(
                _option("true", "Verdadero", "True", "Sandt"),
                _option("false", "Falso", "False", "Falsk"),
            ...
            accepted_answers=(),
            explanation=_t(
                "continue salta a la siguiente iteración; break termina el bucle.",
                "continue skips to the next iteration; break terminates the loop.",
                "continue går videre til næste iteration; break afslutter løkken.",
            ),
        ),
        LocalizedAssessmentItem(
            item_id="m03.a13",
            activity_type=ActivityType.SHORT_ANSWER,
            prompt=_t(
                "¿Cuántas veces se ejecuta el cuerpo interior si range(4) contiene el exterior y range(7) el interior? Justifica.",
                "How many times does the inner body execute when range(4) controls the outer loop and range(7) the inner loop? Justify.",
                "Hvor mange gange udføres den indre krop, når range(4) styrer den ydre løkke og range(7) den indre? Begrund.",
            ),
            options=(),
            correct_option_ids=(),
            accepted_answers=(
                _t(
                    "28, porque 4 iteraciones exteriores ejecutan 7 iteraciones interiores cada una.",
                    "28, because 4 outer iterations each execute 7 inner iterations.",
                    "28, fordi 4 ydre iterationer hver udfører 7 indre iterationer.",
                ),
            ),
            explanation=_t(
                "Los recuentos se multiplican: 4 × 7.",
                "The counts multiply: 4 × 7.",
                "Antallene multipliceres: 4 × 7.",
            ),
            rubric=(
                _t("Indica 28.", "States 28.", "Angiver 28."),
                _t(
                    "Explica el producto de los dos límites.",
                    "Explains the product of the two bounds.",
                    "Forklarer produktet af de to grænser.",
                ),
            ),
        ),
        LocalizedAssessmentItem(
            ...
            activity_type=ActivityType.ORAL_EXPLANATION,
            prompt=_t(
                "Explica cómo probarías un while que procesa hasta encontrar un centinela, incluyendo el caso de entrada vacía.",
                "Explain how you would test a while loop that processes until a sentinel, including empty input.",
                "Forklar hvordan du ville teste en while-løkke, der behandler indtil en stopværdi, inklusive tomt input.",
            ),
            options=(),
            correct_option_ids=(),
            accepted_answers=(
                _t(
                    "Probaría el centinela como primer valor, un dato seguido del centinela, varios datos, un dato límite y comprobaría que el centinela no se procesa.",
                    "I would test the sentinel as the first value, one datum followed by the sentinel, several data values, a boundary value, and verify that the sentinel is not processed.",
                    "Jeg ville teste stopværdien som første værdi, én dataværdi efterfulgt af stopværdien, flere dataværdier, en grænseværdi og kontrollere, at stopværdien ikke behandles.",
                ),
            ),
            explanation=_t(
                "Las pruebas deben verificar terminación, cero iteraciones y exclusión del centinela.",
                "Tests should verify termination, zero iterations, and exclusion of the sentinel.",
                "Test bør verificere afslutning, nul iterationer og udelukkelse af stopværdien.",
            ),
            rubric=(
                _t(
                    "Incluye el centinela como primera entrada.",
                    "Includes the sentinel as the first input.",
                    "Medtager stopværdien som første input.",
                ),
                _t(
                    "Incluye una y varias iteraciones.",
                    "Includes one and several iterations.",
                    "Medtager én og flere iterationer.",
                ),
                _t(
                    "Comprueba que el centinela no se acumula.",
                    "Checks that the sentinel is not accumulated.",
                    "Kontrollerer at stopværdien ikke akkumuleres.",
                ),
                _t(
                    "Verifica que el bucle termina.",
                    "Verifies that the loop terminates.",
                    "Verificerer at løkken afslutter.",
                ),
            ),
        ),
    ),
    tutor_support=LocalizedTutorSupportPacket(
        ...
        knowledge_fragments=(
            _t(
                "while evalúa su condición antes de cada iteración.",
                "while evaluates its condition before every iteration.",
                "while evaluerer sin betingelse før hver iteration.",
            ),
            _t(
                "Un while puede ejecutar cero veces.",
                "A while loop may execute zero times.",
                "En while-løkke kan udføres nul gange.",
            ),
            _t(
                "Una medida de progreso acotada sustenta el argumento de terminación.",
                "A bounded progress measure supports a termination argument.",
                "Et afgrænset fremdriftsmål understøtter et afslutningsargument.",
            ),
            _t(
                "Un invariante debe mantenerse antes y después de cada iteración.",
                "An invariant must hold before and after each iteration.",
                "En invariant skal gælde før og efter hver iteration.",
            ),
            _t(
                "range(stop) excluye stop.",
                "range(stop) excludes stop.",
                "range(stop) udelukker stop.",
            ),
            _t(
                "range(n) genera exactamente n enteros desde 0.",
                "range(n) generates exactly n integers starting at 0.",
                "range(n) genererer præcis n heltal fra 0.",
            ),
            _t(
                "Un contador registra ocurrencias y suele comenzar en 0.",
                "A counter records occurrences and usually starts at 0.",
                "En tæller registrerer forekomster og begynder normalt ved 0.",
            ),
            _t(
                "Un acumulador de suma utiliza 0 como identidad inicial.",
                "A summation accumulator uses 0 as its initial identity.",
                "En sumakkumulator bruger 0 som startidentitet.",
            ),
            _t(
                "El centinela controla el final y no debe procesarse como dato.",
                "A sentinel controls termination and should not be processed as data.",
                "En stopværdi styrer afslutningen og bør ikke behandles som data.",
            ),
            _t(
            ...
            _t(
                "continue omite el resto del cuerpo y pasa a la siguiente iteración.",
                "continue skips the rest of the body and moves to the next iteration.",
                "continue springer resten af kroppen over og går til næste iteration.",
            ),
            _t(
                "Los recuentos de dos bucles anidados suelen multiplicarse.",
                "The counts of two nested loops usually multiply.",
                "Antallene for to indlejrede løkker multipliceres normalt.",
            ),
            _t(
                "Cero, una y varias iteraciones requieren pruebas distintas.",
                "Zero, one, and many iterations require distinct tests.",
                "Nul, én og mange iterationer kræver forskellige test.",
            ),
            _t(
                "Un límite de tiempo detecta una posible no terminación, pero no demuestra corrección.",
                "A time limit detects possible non-termination but does not prove correctness.",
                "En tidsgrænse opdager mulig manglende afslutning, men beviser ikke korrekthed.",
            ),
        ),
        common_misconceptions=(
            _t(
                "Creer que while ejecuta el cuerpo al menos una vez.",
                "Believing while always executes at least once.",
                "At tro at while altid udføres mindst én gang.",
            ),
            _t(
                "Olvidar actualizar una variable de la condición.",
                "Forgetting to update a variable used by the condition.",
                "At glemme at opdatere en variabel i betingelsen.",
            ),
            _t(
                "Suponer que range incluye su límite superior.",
                "Assuming range includes its upper bound.",
                "At antage at range medtager sin øvre grænse.",
            ),
            _t(
                "Inicializar una suma en 1.",
                "Initializing a sum to 1.",
                "At initialisere en sum til 1.",
            ),
            _t(
                "Usar un número arbitrario como máximo inicial sin justificarlo.",
                "Using an arbitrary initial maximum without justification.",
                "At bruge et vilkårligt startmaksimum uden begrundelse.",
            ),
            _t(
                "Sumar el valor centinela antes de comprobarlo.",
                "Adding the sentinel before checking it.",
                "At lægge stopværdien til før den kontrolleres.",
            ),
            _t(
                "Creer que continue termina el bucle.",
                "Believing continue terminates the loop.",
                "At tro at continue afslutter løkken.",
            ),
            _t(
                "Creer que break abandona todos los bucles anidados.",
                "Believing break exits every nested loop.",
                "At tro at break forlader alle indlejrede løkker.",
            ),
            _t(
                "Confundir número de iteraciones con último valor de range.",
                "Confusing iteration count with the last range value.",
                "At forveksle iterationsantal med den sidste range-værdi.",
            ),
            _t(
                "Probar solo un caso con varias iteraciones.",
                "Testing only one many-iteration case.",
                "Kun at teste ét tilfælde med mange iterationer.",
            ),
            _t(
                "Considerar correcto un bucle solo porque termina.",
                "Considering a loop correct merely because it terminates.",
                "At betragte en løkke som korrekt alene fordi den afslutter.",
            ),
            _t(
                "Añadir break para ocultar una condición de bucle mal diseñada.",
                "Adding break to hide a poorly designed loop condition.",
                "At tilføje break for at skjule en dårligt designet løkkebetingelse.",
            ),
        ),
        socratic_questions=(
            _t(
                "¿Qué variables describen el estado antes de la primera iteración?",
                "Which variables describe state before the first iteration?",
                "Hvilke variable beskriver tilstanden før første iteration?",
            ),
            _t(
                "¿Qué condición exacta permite otra iteración?",
                "What exact condition permits another iteration?",
                "Hvilken præcis betingelse tillader endnu en iteration?",
            ),
            _t(
                "¿Qué instrucción demuestra progreso hacia la salida?",
                "Which statement demonstrates progress towards exit?",
                "Hvilken instruktion viser fremdrift mod afslutning?",
            ),
            _t(
                "¿Qué propiedad permanece cierta después de cada iteración?",
                "Which property remains true after every iteration?",
                "Hvilken egenskab forbliver sand efter hver iteration?",
            ),
            _t(
                "¿Cuáles son exactamente los valores producidos por range?",
                "What exact values are produced by range?",
                "Hvilke præcise værdier produceres af range?",
            ),
            _t(
                "¿Esta variable es contador, acumulador, indicador o mejor valor?",
                "Is this variable a counter, accumulator, flag, or best value?",
                "Er denne variabel en tæller, akkumulator, et flag eller en bedste værdi?",
            ),
            _t(
                "¿El centinela se comprueba antes o después de procesar el dato?",
                "Is the sentinel checked before or after processing the datum?",
                "Kontrolleres stopværdien før eller efter behandling af data?",
            ),
            _t(
                "¿Qué instrucciones se omiten cuando se ejecuta continue?",
                "Which statements are skipped when continue executes?",
                "Hvilke instruktioner springes over, når continue udføres?",
            ),
            _t(
                "¿Qué bucle abandona este break?",
                "Which loop does this break exit?",
                "Hvilken løkke forlader dette break?",
            ),
            _t(
                "¿Cuántas combinaciones produce el producto de los límites?",
                "How many combinations does the product of the bounds produce?",
                "Hvor mange kombinationer giver produktet af grænserne?",
            ),
            _t(
                "¿Qué entrada produce cero iteraciones?",
                "Which input produces zero iterations?",
                "Hvilket input giver nul iterationer?",
            ),
            _t(
                "¿Qué prueba distingue n de n + 1 iteraciones?",
                "Which test distinguishes n from n + 1 iterations?",
                "Hvilken test skelner mellem n og n + 1 iterationer?",
            ),
        ),
        grading_criteria=(
            _t(
                "Identifica correctamente estado, condición y actualización.",
                "Correctly identifies state, condition, and update.",
                "Identificerer korrekt tilstand, betingelse og opdatering.",
            ),
            _t(
                "Distingue while de for según la estructura del problema.",
                "Distinguishes while from for according to problem structure.",
                "Skelner while fra for ud fra problemets struktur.",
            ),
            _t(
                "Predice con precisión los valores de range.",
                "Accurately predicts range values.",
                "Forudsiger range-værdier præcist.",
            ),
            _t(
                "Traza el orden real de condición, cuerpo y actualización.",
                "Traces the actual order of condition, body, and update.",
                "Gennemgår den faktiske rækkefølge af betingelse, krop og opdatering.",
            ),
            _t(
                "Formula una medida de progreso y un límite.",
                "States a progress measure and a bound.",
                "Angiver et fremdriftsmål og en grænse.",
            ),
            _t(
                "Formula un invariante relacionado con el resultado parcial.",
                "States an invariant related to the partial result.",
                "Angiver en invariant knyttet til delresultatet.",
            ),
            _t(
                "Inicializa contadores y acumuladores con valores coherentes.",
                "Initializes counters and accumulators coherently.",
                "Initialiserer tællere og akkumulatorer sammenhængende.",
            ),
            _t(
                "Utiliza break y continue solo con una justificación clara.",
                "Uses break and continue only with clear justification.",
                "Bruger kun break og continue med klar begrundelse.",
            ),
            _t(
                "Calcula correctamente el número de operaciones de bucles anidados.",
                "Correctly calculates nested-loop operation counts.",
                "Beregner korrekt antallet af operationer i indlejrede løkker.",
            ),
            _t(
                "Diseña pruebas para cero, una, varias iteraciones y límites.",
                "Designs tests for zero, one, many iterations, and boundaries.",
                "Designer test for nul, én, mange iterationer og grænser.",
            ),
        ),
        response_constraints=(
            ...
            _t(
                "No introducir funciones, clases ni comprensión de listas como atajos del módulo.",
                "Do not introduce functions, classes, or list comprehensions as shortcuts for this module.",
                "Indfør ikke funktioner, klasser eller list comprehensions som genveje i modulet.",
            ),
            _t(
                "Separar siempre el argumento de terminación del argumento de resultado.",
                "Always separate the termination argument from the result argument.",
                "Adskil altid afslutningsargumentet fra resultatargumentet.",
            ),
            _t(
                "Al explicar range, enumerar los valores concretos cuando sea útil.",
                "When explaining range, enumerate concrete values when useful.",
                "Ved forklaring af range skal konkrete værdier angives, når det er nyttigt.",
            ),
            _t(
                "No aceptar un acumulador sin revisar su valor inicial.",
                "Do not accept an accumulator without checking its initial value.",
                "Acceptér ikke en akkumulator uden at kontrollere startværdien.",
            ),
            _t(
                "Cuando aparezca break, indicar exactamente qué bucle termina.",
                "When break appears, state exactly which loop terminates.",
                "Når break forekommer, angiv præcist hvilken løkke der afsluttes.",
            ),
            _t(
                "No presentar los valores didácticos como umbrales clínicos o de laboratorio.",
                "Do not present teaching values as clinical or laboratory thresholds.",
                "Præsentér ikke undervisningsværdier som kliniske eller laboratoriemæssige grænser.",
            ),
            _t(
                "Mantener los ejemplos dentro del alcance de iteración, sin ocultar el proceso con bibliotecas avanzadas.",
                "Keep examples within iteration scope without hiding the process behind advanced libraries.",
                "Hold eksempler inden for iteration uden at skjule processen bag avancerede biblioteker.",
            ),
            _t(
                "Si un bucle puede no terminar, señalar la entrada y la actualización responsables.",
                "If a loop may not terminate, identify the responsible input and update.",
                "Hvis en løkke muligvis ikke afslutter, identificér det ansvarlige input og opdateringen.",
            ),
        ),
        source_basis=(
