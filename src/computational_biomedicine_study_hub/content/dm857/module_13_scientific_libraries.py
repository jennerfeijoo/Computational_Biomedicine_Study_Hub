...
_CONCEPTS = (('imports-and-namespaces',
...
_EXAMPLES = (('array-standardization',
  ('Estandarización por columnas', 'Column-wise standardization', 'Kolonnevis standardisering'),
 ...
 ('broadcast-centering',
  ...
  [('La matriz tiene forma (n, p).',
   ...
   ('La media tiene forma (p,).', 'The mean has shape (p,).', 'Middelværdien har formen (p,).'),
 ...
 ('dataframe-filter',
  ...
  [('Construir una máscara booleana.', 'Build a Boolean mask.', 'Byg en boolesk maske.'),
   ...
   ('Copiar antes de transformar.', 'Copy before transforming.', 'Kopiér før transformering.')],
  'import pandas as pd\n'
  '\n'
...
LOCALIZED_MODULE_13_SCIENTIFIC_LIBRARIES = LocalizedLearningModule(
 ...
 'Reproducerbarhed afhænger af både miljø og transformationer.'),
            rubric=(('Incluye versiones.', 'Includes versions.', 'Medtager versioner.'),
 ...
 ('Interpreta axis correctamente.', 'Interprets axis correctly.', 'Fortolker axis korrekt.'),
...
_OBJECTIVE_MCQS = (('001',
  ...
  [('module',
   ...
   ('star',
    ('from statistics import *', 'from statistics import *', 'from statistics import *')),
   ('global',
 ...
 ('003',
  ...
  [('size', ('Número de elementos', 'Element count', 'Antal elementer')),
   ...
   ('dtype_change',
    ('Cambio obligatorio de dtype', 'Mandatory dtype change', 'Obligatorisk dtype-ændring'))],
  'size',
 ...
 ('008',
  ...
  [('validate', ("validate='one_to_one'", "validate='one_to_one'", "validate='one_to_one'")),
 ...
 ('014',
  ...
  [('missing', ('Valores ausentes', 'Missing values', 'Manglende værdier')),
   ('syntax', ('Errores de sintaxis siempre', 'Always syntax errors', 'Altid syntaksfejl')),
