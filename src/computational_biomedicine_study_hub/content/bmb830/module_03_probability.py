...
interval=0.210 to 0.390""",
    ...
    practices=(
        (
            ...
            (
                (
                    "Observa qué evento restringe el denominador.",
                    "Observe which event restricts the denominator.",
                    "Se hvilken hændelse der begrænser nævneren.",
                ),
            ),
            (
        ...
        (
            ...
            (
                (
                    "El resultado individual es binario.",
                    "The individual outcome is binary.",
                    "Det individuelle udfald er binært.",
                ),
            ),
            (
        ...
        (
            ...
            (
                (
                    "Piensa en la secuencia pseudoaleatoria.",
                    "Think about the pseudo-random sequence.",
                    "Tænk på den pseudo-tilfældige sekvens.",
                ),
            ),
            (
        ...
        (
            ...
            (
                (
                    "Identifica unidades independientes.",
                    "Identify independent units.",
                    "Identificér uafhængige enheder.",
                ),
            ),
            (
        ...
        (
            ...
            (
                (
                    "Una describe individuos; la otra, un estimador.",
                    "One describes individuals; the other an estimator.",
                    "Den ene beskriver individer; den anden en estimator.",
                ),
            ),
            (
    ...
    mcqs=(
        (
            "001",
            (
                "¿Cuál expresa sensibilidad?",
                "Which expression represents sensitivity?",
                "Hvilket udtryk repræsenterer sensitivitet?",
            ),
            (
                ("a", ("P(enfermedad|positivo)", "P(disease|positive)", "P(sygdom|positiv)")),
                ("b", ("P(positivo|enfermedad)", "P(positive|disease)", "P(positiv|sygdom)")),
                ("c", ("P(enfermedad)", "P(disease)", "P(sygdom)")),
                ("d", ("P(positivo)", "P(positive)", "P(positiv)")),
            ),
            "b",
            (
                "Sensibilidad condiciona en enfermedad.",
                "Sensitivity conditions on disease.",
                "Sensitivitet betinger på sygdom.",
            ),
        ),
        (
            "002",
            (
                "¿Qué modelo cuenta éxitos en n ensayos?",
                "Which model counts successes in n trials?",
                "Hvilken model tæller succeser i n forsøg?",
            ),
            (
                ("binomial", ("Binomial", "Binomial", "Binomial")),
                ("normal", ("Normal", "Normal", "Normal")),
                ("uniform", ("Uniforme", "Uniform", "Uniform")),
                ("exponential", ("Exponencial", "Exponential", "Eksponential")),
            ),
            "binomial",
            (
                "La binomial modela conteos de éxitos.",
                "The binomial models success counts.",
                "Binomialfordelingen modellerer antal succeser.",
            ),
        ),
        (
            "003",
            (
                "¿Qué devuelve dbinom(k,...)?",
                "What does dbinom(k,...) return?",
                "Hvad returnerer dbinom(k,...)?",
            ),
            (
                ("point", ("P(X=k)", "P(X=k)", "P(X=k)")),
                ("cum", ("P(X≤k)", "P(X≤k)", "P(X≤k)")),
                ("sample", ("Una muestra", "A sample", "En stikprøve")),
                ("mean", ("La media", "The mean", "Gennemsnittet")),
            ),
            "point",
            ("dbinom es masa puntual.", "dbinom is point mass.", "dbinom er punktmasse."),
        ),
        (
            "004",
            (
                "¿Qué describe el error estándar?",
                "What does standard error describe?",
                "Hvad beskriver standardfejl?",
            ),
            (
                (
                    "statistic",
                    ("Variación del estimador", "Estimator variation", "Estimatorens variation"),
                ),
                (
                    "individual",
                    ("Variación individual", "Individual variation", "Individuel variation"),
                ),
                ("range", ("Rango observado", "Observed range", "Observeret interval")),
                ("missing", ("Ausencia", "Missingness", "Manglende data")),
            ),
            "statistic",
            (
                "Es la desviación estándar de la distribución muestral.",
                "It is the standard deviation of the sampling distribution.",
                "Det er standardafvigelsen for stikprøvefordelingen.",
            ),
        ),
        (
            "005",
            ("¿Qué hace set.seed?", "What does set.seed do?", "Hvad gør set.seed?"),
            (
                (
                    "sequence",
                    (
                        "Fija secuencia pseudoaleatoria",
                        "Fixes pseudo-random sequence",
                        "Fastlægger pseudo-tilfældig sekvens",
                    ),
                ),
                ("truth", ("Valida el modelo", "Validates the model", "Validerer modellen")),
                ("normal", ("Hace normales los datos", "Makes data normal", "Gør data normale")),
                (
                    "independent",
                    ("Crea independencia", "Creates independence", "Skaber uafhængighed"),
                ),
            ),
            "sequence",
            (
                "La semilla permite repetir la secuencia.",
                "The seed permits repeating the sequence.",
                "Seedet gør sekvensen gentagelig.",
            ),
        ),
        (
            "006",
            (
                "¿Qué define el n efectivo?",
                "What defines effective n?",
                "Hvad definerer effektivt n?",
            ),
            (
                (
                    "independent",
                    ("Unidades independientes", "Independent units", "Uafhængige enheder"),
                ),
                ("rows", ("Número de filas", "Number of rows", "Antal rækker")),
                ("columns", ("Número de columnas", "Number of columns", "Antal kolonner")),
                ("files", ("Número de archivos", "Number of files", "Antal filer")),
            ),
            "independent",
            (
                "Las réplicas correlacionadas no añaden una unidad completa.",
                "Correlated replicates do not add a full unit.",
        ...
        (
            "007",
            (
                "¿Qué distribución es continua y simétrica?",
                "Which distribution is continuous and symmetric?",
                "Hvilken fordeling er kontinuert og symmetrisk?",
            ),
            (
                ("normal", ("Normal", "Normal", "Normal")),
                ("binomial", ("Binomial", "Binomial", "Binomial")),
                ("bernoulli", ("Bernoulli", "Bernoulli", "Bernoulli")),
                ("categorical", ("Categórica", "Categorical", "Kategorisk")),
            ),
            "normal",
            (
                "La normal está definida por media y desviación estándar.",
                "The normal is defined by mean and standard deviation.",
                "Normalfordelingen defineres ved gennemsnit og standardafvigelse.",
            ),
        ),
        (
            "008",
            (
                "¿Qué indica sobredispersión binomial?",
                "What does binomial overdispersion indicate?",
                "Hvad indikerer binomial overdispersion?",
            ),
            (
                (
                    "insufficient",
                    ("Modelo insuficiente", "Insufficient model", "Utilstrækkelig model"),
                ),
                ("perfect", ("Ajuste perfecto", "Perfect fit", "Perfekt fit")),
                ("normal", ("Normalidad", "Normality", "Normalitet")),
                ("missing", ("Solo NA", "Only NA", "Kun NA")),
            ),
            "insufficient",
            (
                "Puede reflejar heterogeneidad o dependencia.",
                "It may reflect heterogeneity or dependence.",
                "Det kan afspejle heterogenitet eller afhængighed.",
            ),
        ),
    ),
    true_false=(
        (
            "009",
            (
                "P(A|B) y P(B|A) son intercambiables.",
                "P(A|B) and P(B|A) are interchangeable.",
                "P(A|B) og P(B|A) kan byttes.",
            ),
            False,
            (
                "Tienen denominadores distintos.",
                "They have different denominators.",
                "De har forskellige nævnere.",
            ),
        ),
        (
            "010",
            (
                "La binomial supone un p común bajo el modelo.",
                "The binomial assumes a common p under the model.",
                "Binomialfordelingen antager et fælles p under modellen.",
            ),
            True,
            (
                "Es parte del mecanismo binomial.",
                "It is part of the binomial mechanism.",
                "Det er en del af binomialmekanismen.",
            ),
        ),
        (
            "011",
            (
                "Toda variable continua es normal.",
                "Every continuous variable is normal.",
                "Enhver kontinuert variabel er normal.",
            ),
            False,
            (
                "Continuidad no implica normalidad.",
                "Continuity does not imply normality.",
                "Kontinuitet indebærer ikke normalitet.",
            ),
        ),
        (
            "012",
            (
                "El error estándar suele disminuir al aumentar n independiente.",
                "Standard error usually decreases as independent n increases.",
                "Standardfejl falder normalt når uafhængigt n stiger.",
            ),
            True,
            (
                "Frecuentemente escala con 1/sqrt(n).",
                "It often scales with 1/sqrt(n).",
                "Det skalerer ofte med 1/sqrt(n).",
            ),
        ),
        (
            "013",
            (
                "Tres réplicas del mismo paciente son tres pacientes independientes.",
                "Three replicates from one patient are three independent patients.",
                "Tre replikater fra én patient er tre uafhængige patienter.",
            ),
            False,
            (
                "Comparten unidad biológica.",
                "They share a biological unit.",
                "De deler biologisk enhed.",
            ),
        ),
        (
            "014",
            (
                "Una simulación válida debe representar el mecanismo relevante.",
                "A valid simulation must represent the relevant mechanism.",
                "En gyldig simulation skal repræsentere den relevante mekanisme.",
            ),
            True,
            (
                "Repetir código incorrecto no valida supuestos.",
                "Repeating incorrect code does not validate assumptions.",
                "Gentagelse af forkert kode validerer ikke antagelser.",
            ),
        ),
        (
            "015",
            (
                "set.seed demuestra que el modelo es correcto.",
                "set.seed proves the model is correct.",
                "set.seed beviser at modellen er korrekt.",
            ),
            False,
            (
                "Solo controla reproducibilidad pseudoaleatoria.",
                "It only controls pseudo-random reproducibility.",
                "Det kontrollerer kun pseudo-tilfældig reproducerbarhed.",
            ),
        ),
        (
            "016",
            (
                "La desviación estándar y el error estándar responden a preguntas distintas.",
                "Standard deviation and standard error answer different questions.",
                "Standardafvigelse og standardfejl besvarer forskellige spørgsmål.",
            ),
            True,
            (
                "Una describe observaciones y la otra un estimador.",
                "One describes observations and the other an estimator.",
                "Den ene beskriver observationer og den anden en estimator.",
            ),
        ),
    ),
    tutor=(
        ...
        (
            (
                "El orden del condicionamiento importa.",
                "Conditioning order matters.",
                "Betingningsrækkefølgen betyder noget.",
            ),
            (
                "La binomial modela conteos bajo supuestos.",
                "The binomial models counts under assumptions.",
                "Binomialfordelingen modellerer antal under antagelser.",
            ),
            (
                "El error estándar pertenece a un estimador.",
                "Standard error belongs to an estimator.",
                "Standardfejl tilhører en estimator.",
            ),
            (
                "La simulación debe imitar el mecanismo.",
                "Simulation must imitate the mechanism.",
                "Simulation skal efterligne mekanismen.",
            ),
        ),
        (
            (
                "Invertir sensibilidad y valor predictivo.",
                "Reversing sensitivity and predictive value.",
                "At vende sensitivitet og prædiktiv værdi.",
            ),
            (
                "Contar réplicas como unidades independientes.",
                "Counting replicates as independent units.",
                "At tælle replikater som uafhængige enheder.",
            ),
            ("Confundir SD y SE.", "Confusing SD and SE.", "At forveksle SD og SE."),
        ),
        (
            (
                "¿Cuál es el espacio condicionado?",
                "What is the conditioned space?",
                "Hvad er det betingede rum?",
            ),
            (
                "¿Qué mecanismo genera el dato?",
                "What mechanism generates the data?",
                "Hvilken mekanisme genererer data?",
            ),
            (
        ...
        (
            (
                "Define eventos y denominadores.",
                "Defines events and denominators.",
                "Definerer hændelser og nævnere.",
            ),
            ("Justifica la distribución.", "Justifies the distribution.", "Begrunder fordelingen."),
            (
                "Interpreta incertidumbre correctamente.",
                "Interprets uncertainty correctly.",
                "Fortolker usikkerhed korrekt.",
            ),
        ),
        (
            (
                "No inventar prevalencias ni independencia.",
                "Do not invent prevalence or independence.",
                "Opfind ikke prævalens eller uafhængighed.",
            ),
            (
                "No presentar aproximaciones como exactas.",
                "Do not present approximations as exact.",
                "Præsenter ikke approximationer som eksakte.",
            ),
            (
