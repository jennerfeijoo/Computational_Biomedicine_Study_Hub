"""Compact authoring contract for complete BMB831 modules."""
...
class StandardModuleSpec:
    """A dense BMB831 module with enforced academic coverage."""
    ...
    def __post_init__(self) -> None:
        ...
        for name, (actual, minimum) in minimums.items():
            if actual < minimum:
                raise ValueError(
                    f"BMB831 module {self.module_id!r} requires at least {minimum} "
...
def build_module(spec: StandardModuleSpec) -> LocalizedLearningModule:
    """Build and validate one complete trilingual BMB831 learning module."""
