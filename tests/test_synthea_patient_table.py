...
def _snapshot(root: Path) -> None:
    ...
    _write_csv(
        ...
        (
            ...
            ("2025-06-25", "P01", "E02", "8480-6", "Systolic Blood Pressure", "120", "mm[Hg]", "numeric"),
            ("2025-07-01", "P01", "E03", "8462-4", "Diastolic Blood Pressure", "80", "mm[Hg]", "numeric"),
            ("2025-06-25", "P01", "E02", "X", "Qualitative finding", "positive", "", "text"),
            ("2025-04-20", "P02", "E04", "8462-4", "Diastolic Blood Pressure", "70", "mm[Hg]", "numeric"),
